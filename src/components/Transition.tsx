...
export const Transition = () => {
  const [seledtAssignee, setSeledtAssignee] = useState<string>("");
  const [taskList, setTaskList] = useState<Task[]>(tasks);
  const [isShowList, setIsShowList] = useState<boolean>(false);

  const onClickAssignee = (assignee: string) => {
    setSeledtAssignee(assignee);
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <Avatar
          isSelected={seledtAssignee === member.a}
          onClick={onClickAssignee}
        >
          {member.a}
        </Avatar>
        <Avatar
          isSelected={seledtAssignee === member.b}
          onClick={onClickAssignee}
        >
          {member.b}
        </Avatar>
        <Avatar
          isSelected={seledtAssignee === member.c}
          onClick={onClickAssignee}
        >
          {member.c}
        </Avatar>
